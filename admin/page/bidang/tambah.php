...
<div class="page-title-head d-flex align-items-center gap-2">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0 fs-13">
            ...
            <li class="breadcrumb-item"><a href="javascript: void(0);">Bidang Kompetensi</a></li>            
                ...
                <form method="post" enctype="multipart/form-data" action=""> 
                    ...
                    <div class="row">
                        <div class="col-sm-10 ms-auto">
                            ...
                            <a href="?page=bidang" class="btn btn-danger btn-sm">Kembali</a> 
                        </div>
                    </div> 
                </form>
                <?php
                    if (isset($_POST['tambah'])) {
                        ...
                        $cek_username_query = "SELECT COUNT(*) AS jumlah FROM bidang WHERE bidang = '$bidang'";
                        ...
                        if ($cek_username_data['jumlah'] > 0) {
                            ...
                            $query = "INSERT INTO bidang (bidang) VALUES ('$bidang')";
