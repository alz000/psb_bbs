...
<div class="page-title-head d-flex align-items-center gap-2">
    ...
    <div class="text-end">
        <ol class="breadcrumb m-0 py-0 fs-13">
            ...
            <li class="breadcrumb-item"><a href="javascript: void(0);">Golongan Darah</a></li>            
            ...
            <div class="card-body">
                ...
                <?php
                    if (isset($_POST['tambah'])) {
                        ...
                        $cek_username_query = "SELECT COUNT(*) AS jumlah FROM darah WHERE darah = '$darah'";
