            ...
            <div class="card-body">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2" data-toggle="select2" name="id_pembayaran" id="id_pembayaran" required onchange="tampilkanNotelp()">
                                ...
                                <?php
                                $sql_kar = mysqli_query($con, "SELECT * FROM pembayaran NATURAL JOIN calon_santri WHERE status_santri='Sudah Melakukan Pembayaran, Silahkan Upload Berkas'");
                ...
                <?php
                    if (isset($_POST['tambah'])) { 
                        ...
                        $folderTujuan = "assets/gambar/berkas/";
