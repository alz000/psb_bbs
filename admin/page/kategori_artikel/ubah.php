            ...
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action=""> 
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" name="alias" value="<?= $row['alias']; ?>" required>
                        </div>
                        <div class="col-sm-3">
                            <select name="s_kategori" class="form-control">
                                <option value="Aktif" <?= ($row['s_kategori'] == 'Aktif') ? 'selected' : ''; ?>>Aktif</option>
                                <option value="Tidak Aktif" <?= ($row['s_kategori'] == 'Tidak Aktif') ? 'selected' : ''; ?>>Tidak Aktif</option>
                            </select>
                        </div>
                    </div> 
                    <div class="row">
                ...
                <?php 
                    if (isset($_POST['ubah'])) {
                        ...
                        $query = "UPDATE kategori SET kategori='$kategori',alias='$alias',s_kategori='$s_kategori' WHERE id_kategori='$id_kategori'";
