<?php
$nama_dokumen = 'Laporan Calon Santri Baru Belum Melengkapi Berkas';
...
<body>
    ...
    <p align="center"><b>Laporan Calon Santri Baru Belum Melengkapi Berkas</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM calon_santri WHERE status_santri='Sudah Melakukan Pembayaran, Silahkan Upload Berkas' ORDER BY nisn ASC"); ?>
