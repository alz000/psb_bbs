<?php
$nama_dokumen = 'Laporan Calon Santri Baru';
...
<body>
    ...
    <p align="center"><b>Laporan Calon Santri Baru <br> <small> Berdasarkan Jenjang Pendidikan <?= $jenjang ?></small></b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM calon_santri WHERE jenjang='$jenjang' ORDER BY nisn ASC"); ?>
