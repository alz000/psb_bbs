<?php
$nama_dokumen = 'Laporan Calon Santri Baru Berdasarkan Kabupaten';
...
$query = $con->query("SELECT nama FROM wilayah_2022 WHERE kode = '$kabupaten'");
$kabupaten_row = $query->fetch_assoc();
$nama_kabupaten = $kabupaten_row['nama'];  
?>
...
<body>
    ...
    <p align="center"><b>Laporan Calon Santri Baru Berdasarkan Kabupaten <br> <small><?= $nama_kabupaten ?></small></b></p> 
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        <tr>
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; vertical-align: middle;">Jenjang</td>
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; vertical-align: middle;">Kabupaten</td> 
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM calon_santri WHERE kabupaten='$kabupaten' ORDER BY nisn ASC"); ?>
        ...
        <tr>      
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?= $nama_kabupaten; ?></td>
