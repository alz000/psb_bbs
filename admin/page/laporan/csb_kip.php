<?php
$nama_dokumen = 'Laporan Calon Santri Baru Penerima Kartu Indonesia Pintar';
...
<body>
    ...
    <p align="center"><b>Laporan Calon Santri Baru Penerima Kartu Indonesia Pintar</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        <tr>
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; vertical-align: middle;">Penerima KIP</td>
        </tr> 
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM calon_santri NATURAL JOIN pembayaran ORDER BY nisn ASC"); ?>
        ...
        <tr>      
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;">
                <?php 
                $sql_kip = mysqli_query($con, "SELECT * FROM berkas WHERE id_pembayaran = '$row[id_pembayaran]' AND kip IS NOT NULL");
                $data_kip = mysqli_fetch_array($sql_kip);

                if (!empty($data_kip['kip'])) {
                    echo "Penerima KIP";
                } else {
                    echo "Bukan Penerima KIP";
                }
                ?>
            </td>
        </tr> 
