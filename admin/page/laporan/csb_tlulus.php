<?php
$nama_dokumen = 'Laporan Calon Santri Baru Tidak Lulus';
...
<body>
    ...
    <p align="center"><b>Laporan Calon Santri Baru Tidak Lulus</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        ...
        <?php $nomor=1; ?>
        <?php $ambil=$con->query("SELECT * FROM calon_santri NATURAL JOIN tes_masuk WHERE keterangan='Tidak Lulus' ORDER BY total_nilai DESC"); ?>
