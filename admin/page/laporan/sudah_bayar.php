<?php
$nama_dokumen = 'Laporan Calon Santri Baru Sudah Melakukan Pembayaran';
...
<body>
    ...
    <p align="center"><b>Laporan Calon Santri Baru Sudah Melakukan Pembayaran</b></p>
    ...
    <table style="width: 100%; border-collapse: collapse; white-space: nowrap;">
        <tr>
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; font-weight: bold; vertical-align: middle;">Tanggal Bayar</td>
        </tr> 
        <?php $nomor=1; ?>
        ...
        <tr>      
            ...
            <td style="font-size: 10px; border: 1px solid #999; padding: 2px; vertical-align: top;"><?= $tgl1; ?></td>   
        </tr> 
        <?php $nomor++; ?>
        <?php } ?> 
    </table> 
