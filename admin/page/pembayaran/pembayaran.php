        ...
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-2">
                    Data Pembayaran 
                    <a href="?page=pembayaran&aksi=tambah" class="btn btn-primary btn-sm float-end">Tambah</a>
                </h4> 
                ...
                <table id="dtTabel" class="table table-striped table-sm w-100 nowrap">
                    ...
                    <tbody>
                        <?php 
                        $nomor = 1; 
                        $ambil = $con->query("SELECT * FROM pembayaran NATURAL JOIN calon_santri ORDER BY nisn ASC");
                        while ($row = $ambil->fetch_assoc()) { 
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="page/laporan/kwitansi.php?id_pembayaran=<?= $row['id_pembayaran'] ?>" target="_blank"><i class="ti ti-mail"></i> Kwitansi</a> 
                                        </div>
                                    </div> 
                                </td> 
                                ...
                                <td>
                                    ...
                                    } elseif ($row['status_santri'] == 'Sudah Melakukan Pembayaran') {
                                        echo "Sudah Melakukan Pembayaran. <br> <a href='?page=pembayaran&aksi=verifikasi&id_pembayaran=$row[id_pembayaran]' class='text-success'>Klik untuk verifikasi pembayaran</a>";
                                    } else {
