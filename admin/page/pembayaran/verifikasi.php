            ...
            <div class="card-body">
                ...
                <table class="table table-borderless"> 
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="assets/gambar/santri/<?php echo $row['bukti']; ?>" target="_blank">Lihat</a> 
                        </td>
                    </tr>
                </table> 

                <a class="btn btn-info" href="?page=pembayaran&aksi=verif_pembayaran&id_pembayaran=<?php echo $row['id_pembayaran'] ?>&nisn=<?php echo $row['nisn'] ?>&notelp=<?php echo $row['notelp'] ?>&nama_admin=<?php echo $admin['nama'] ?>" style="color: white;">Verifikasi</a>
