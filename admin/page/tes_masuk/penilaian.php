                ...
                <?php
                    if (isset($_POST['nilai'])) { 
                        ...
                        if ($con->query($query) === TRUE) {  
                            if ($total_nilai >= 60) {
                                $status_santri = 'Lulus, Segera Daftar Ulang';
                            } else {
                                $status_santri = 'Tidak Lulus';
                            }
                            ...
                            $pesan = "HASIL PENILAIAN TES MASUK CALON SANTRI BARU : \n\n" .
                                     ...
                                     " - Predikat : $grade\n" . 
                                     " - Keterangan : $keterangan\n\n" . 
                                     "*Diharapkan kepada calon santri baru yang sudah dinyatakan lulus untuk mengisi SURAT PERNYATAAN MENJADI SANTRI dan segera untuk melakukan DAFTAR ULANG dan untuk calon santri yang TIDAK LULUS mohon untuk tidak berkecil hati.*"; 
