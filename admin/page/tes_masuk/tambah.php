        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="row mb-2">
                        <label class="col-sm-2">Ruangan TES</label>
                        <div class="col-sm-10">
                            <select class="form-control select2" data-toggle="select2" name="ruangan_tes" required>
                                <option selected disabled>Pilih</option>
                                <?php
                                $sql_kar = mysqli_query($con, "SELECT * FROM ruangan ");
                                while ($kar = mysqli_fetch_array($sql_kar)) {
                                    echo "<option value='$kar[ruangan]'>$kar[ruangan]</option>";
                                }
                                ?>
                            </select> 
                        </div>
                ...
                <?php
                    if (isset($_POST['tambah'])) {
                        ...
                        if ($cek_username_data['jumlah'] > 0) {
                            ...
                            $query = "INSERT INTO tes_masuk (nisn, tgl_tes, jam_tes, ruangan_tes, penguji_satu, penguji_dua) 
                                      VALUES ('$nisn', '$tgl_tes', '$jam_tes', '$ruangan_tes', '$penguji_satu', '$penguji_dua')";
                            ...
                            if ($con->query($query) === TRUE) {
                                ...
                                $pesan = "Jadwal Pemberitahuan Tes : \n\n" .
                                         ...
                                         " - Waktu : $jam_tes\n" .  
                                         " - Ruangan : $ruangan_tes\n" . 
                                         " - Penguji Pertama : $penguji_satu\n" . 
                                         " - Penguji Kedua : $penguji_dua\n" . 
                                         " - TES : Akademik / Pengetahuan Umum, BTQ dan Interview Calon Santri\n\n" . 
                                         "Diharapkan kepada calon santri baru untuk datang 15 menit sebelum waktu sudah ditentukan dan silahkan download KARTU TES, dan bawa KARTU TES ketika TES MASUK.";
