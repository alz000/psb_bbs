                ...
                <?php
                    if (isset($_POST['tambah'])) {
                        ...
                        if ($cek_data['jumlah'] > 0) {
                            ...
                            $query = "INSERT INTO calon_santri (jenjang, nisn, nama_lengkap, nama_panggilan, jk, tmp, tgl, anak_ke, jumlah_saudara, tinggi, berat, id_darah, riwayat_penyakit, alamat, notelp, tempat_tinggal, jarak, sekolah_asal, tgl_ijazah, no_ijazah, lama_belajar, status_santri, password_santri) VALUES ('$jenjang', '$nisn', '$nama_lengkap', '$nama_panggilan', '$jk', '$tmp', '$tgl', '$anak_ke', '$jumlah_saudara', '$tinggi', '$berat', '$id_darah', '$riwayat_penyakit', '$alamat', '$notelp', '$tempat_tinggal', '$jarak', '$sekolah_asal', '$tgl_ijazah', '$no_ijazah', '$lama_belajar','Pending', '$password_santri')";
                                    ...
                                    if ($con->query($query_ibu) === TRUE) { 
                                        ...
                                        echo "<script>
                                                Swal.fire({
                                                    icon: 'error',
                                                    title: 'Gagal!',
                                                    text: 'Terjadi kesalahan saat menyimpan data ibu.',
                                                    confirmButtonText: 'OK'
                                                });
                                              </script>";
                                    }
