                ...
                <table id="dtTabel" class="table table-striped table-sm w-100">
                    ...
                    <tbody>
                        <?php 
                            ...
                            $ambil = $con->query("SELECT * FROM calon_santri NATURAL JOIN tes_masuk WHERE nisn='$nisn' ORDER BY id_tes_masuk ASC"); 
                            ...
                            <tr>
                                <td class="text-center" style="vertical-align: top;">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            <a class="dropdown-item" href="../admin/page/laporan/kartu_tes.php?id_tes_masuk=<?= $row['id_tes_masuk'] ?>" target="_blank"><i class="ti ti-edit"></i> Kartu Tes</a>
                                            <?php if ($nilai_kosong): ?>  
                                            <?php else: ?> 
                                                <a class="dropdown-item"  href="../admin/page/laporan/hasil_tes.php?id_tes_masuk=<?= $row['id_tes_masuk'] ?>" target="_blank"><i class="ti ti-printer"></i> Cetak Hasil Penilaian</a>
                                            <?php endif; ?>
                                        </div>
                                    </div> 
                                </td> 
                                ...
                                <td style="vertical-align: top;">
                                    ...
                                    if (empty($row['btq']) && empty($row['pengetahuan_umum']) && empty($row['total_nilai']) && empty($row['grade']) && empty($row['keterangan'])) {
                                        echo '<span class="text-danger">Siswa belum melakukan tes</span>';
                                    } else {
